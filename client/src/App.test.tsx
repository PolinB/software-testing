...
describe('Component tests', () => {
    describe('Component tests for navigation menu', () => {
        it('Render menu without user', () => {
            const testRender = TestRenderer.create(<BrowserRouter><Navigation isLogin={false} logoutFunc={() => {
            }}/></BrowserRouter>);
        ...
        it('Render menu with user', () => {
            const testRender = TestRenderer.create(<BrowserRouter><Navigation isLogin={true} logoutFunc={() => {
            }}/></BrowserRouter>);
            const testInstance = testRender.root;
            const elements = testInstance.findAllByType(NavLink).map((element: any) =>
                element.props.children
